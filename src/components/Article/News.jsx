...
function News({category, details}) {
    return (
        <div className = "flex flex-col border-b-2">
            <Typography style ="h1" weight = "semibold" className = "pt-1 pb-4 neeto-ui-text-gray-700">{details["title"]}
                <Button icon = {Copy} style = "text"/>
            </Typography>
            <Typography  style = "body1" weight = "normal" className = "neeto-ui-text-gray-500 self-start pb-8">
            {details["author"]} at {details["time"]} on {details["date"]}
            </Typography>
