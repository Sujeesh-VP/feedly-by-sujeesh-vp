    ...
    <div className = "flex  w-3/4  mx-auto mt-10 self-start flex-wrap">  
        ...
        return (    <div className = "flex flex-row items-start mr-4 mb-2">
                        <Tag label = {item}   size="small"  className = "capitalize py-2" onClose = {()=>{
                            ...
                            if (index > -1) {
                              setFilterCategories({...FilterCategories, categories: [...categories.slice(0, index), ...categories.slice(index + 1)]})
                        }}}/>
                    </div>
                )
        })
        ...
        <div className = "flex flex-row items-start mr-4">
            <Tag label = {"Include archived articles"}   size="small"  className = "capitalize py-2" onClose = {()=>{
